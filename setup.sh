...
echo -e "$green.........................................................."$NC
echo -e "$Lyellow                  Autoscript By MZTechTV"$NC
echo -e "$Lyellow                    CONTACT TELEGRAM"$NC
echo -e "$Lyellow                       @MZTechTV"$NC
echo -e "$green.........................................................."$NC
echo ''
...
IZIN=$(curl https://raw.githubusercontent.com/${GitUser}/permission/main/ipvps.conf | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
echo " "
echo -e "\e[1;32m══════════════════Autoscript MZTechTV══════════════════\e[0m" | tee -a log-install.txt
...
echo -e "\e[1;32m══════════════════Autoscript By MZTechTV══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         Premium By MZTechTV             |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
